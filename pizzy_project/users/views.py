...
from pizzy_project.mixins import SendMailMixin

User = get_user_model()

settings.app_static_url = 'app1/{}'.format('app')

def index(request):
    return HttpResponse( ' Thou are at the index page')
